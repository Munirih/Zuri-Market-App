...
This guide explains how to run both the full application on your local machine using Docker-Compose.
...
### Backend env
API_SECRET_KEY=http://localhost:5000
